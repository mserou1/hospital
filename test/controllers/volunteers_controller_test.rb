...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { first_name: @volunteer.first_name, last_name: @volunteer.last_name, organization: @volunteer.organization } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { first_name: @volunteer.first_name, last_name: @volunteer.last_name, organization: @volunteer.organization } }
